...
<html lang="en">
    ...
    <body>
        ...
        <header>
            ...
            <h2 class="col-md-12" style="text-align: center; padding: 5px; background-color: lightgray;" >Taking Attendance</h2>
        </header>
        <div class="container">
            <div style="width: 100%;">
                <form action="TakingAttendance" style="position: relative;padding-bottom: 50px;" method="post">
                    ...
                    <input name="iid" value="${s.getGroup().getInstructor().getId()}" type="hidden">       
                    ...
                    <table class="table"  >
                        ...
                        <tbody>
                            ...
                            <c:forEach var="stu" items="${slist}" varStatus="count">
                                <tr>
                                    <td >${count.count}</td>
